 ...
 */
package com.penjin.android.message.group;
...
import com.penjin.android.activity.BaseActivity;
import com.penjin.android.message.Constant;
import com.penjin.android.message.adapter.GroupAdapter;
...
public class GroupsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		grouplist = EMGroupManager.getInstance().getAllGroups();//从内存中加载群组信息，这个需要在init()中，告诉sdk加载数据进内存
		...
		groupListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				if (position == 0) {
					...
					// 进入群聊
					Intent intent = new Intent(GroupsActivity.this, EMChatActivity.class);
					// it is group chat
