...
public class UserProfileManager {
     ...
     */
    private List<EMChatHelper.DataSyncListener> syncContactInfosListeners;
    ...
    public synchronized boolean init(Context context) {
        ...
        syncContactInfosListeners = new ArrayList<EMChatHelper.DataSyncListener>();
        sdkInited = true;
        return true;
    }

    public void addSyncContactInfoListener(EMChatHelper.DataSyncListener listener) {
        if (listener == null) {
            return;
        }
    ...
    public void removeSyncContactInfoListener(EMChatHelper.DataSyncListener listener) {
        if (listener == null) {
            return;
        }
        if (syncContactInfosListeners.contains(listener)) {
    ...
    public void notifyContactInfosSyncListener(boolean success) {
        for (EMChatHelper.DataSyncListener listener : syncContactInfosListeners) {
