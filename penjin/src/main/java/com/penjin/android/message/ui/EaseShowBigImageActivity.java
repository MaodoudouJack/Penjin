...
import com.penjin.android.message.domain.EaseImageCache;
import com.penjin.android.message.utils.EaseLoadLocalBigImgTask;
import com.penjin.android.message.view.photo.EasePhotoView;

/**
 * 下载显示大图
 * 
 */
public class EaseShowBigImageActivity extends EMBaseActivity {
